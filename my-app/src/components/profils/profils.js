    ...
    return(
        <div className="profilmin">
            ...
            <div className="profilmin__elo">
                <p className="profilmin__1v1">1v1 : {props.elo1}</p>
                <p className="profilmin__2v2">2v2 : {props.elo2}</p>
            </div>
...
function ProfilHead(s)
{
    ...
    return(
        <div className={`profilhead ${place}`}>
            <img src={props.backgroundImage} className="profilhead__backgroundimage"  alt="backgroundimage"/>
        </div>
    )
}
